...
public class SpeechService {
    ...
    private StringBuffer buffer = new StringBuffer(); //字符缓冲区
...
//            showTip("当前正在说话，音量大小 = " + volume + " 返回音频数据 = " + data.length);
    ...
    private void printResult(RecognizerResult results) {
        ...
        String str = format.format(date) + ": " + resultBuffer.toString();
        for (String s : orders) {
            if (resultBuffer.toString().contains(s)) {
                order = s;
                Log.d("order", "___________________________________________ " + order + ":" + str + " __________________________________________");
            }
        }
        Log.d("order", "___________________________________________ " + str + " __________________________________________");
    }
