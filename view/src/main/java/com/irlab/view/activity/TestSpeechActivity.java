...
public class TestSpeechActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIatDialog = new RecognizerDialog(TestSpeechActivity.this, mInitListener);
